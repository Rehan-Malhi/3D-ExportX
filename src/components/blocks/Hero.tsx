...
import JacketViewer from "../sm-blocks/3D-jacket";
    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg font-normal text-white dark:text-white"
        >
          Grow Your Export business with our Easy to Use Dashboard and Features
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
        ...
        >
          <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
            <div className="bg-gray-400 h-[300px] w-full">
              <JacketViewer/>
            </div>
          </div>
        </motion.div>
  ...
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-base font-bold md:text-2xl">ExportX</h1>
      </div>
